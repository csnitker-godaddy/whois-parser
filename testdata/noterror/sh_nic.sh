...
Creation Date: 2002-07-04T07:42:26Z
...
Name Server: b0.nic.sh
Name Server: c0.nic.sh
Name Server: a2.nic.sh
Name Server: a0.nic.sh
DNSSEC: unsigned
URL of the ICANN Whois Inaccuracy Complaint Form: https://www.icann.org/wicf/
>>> Last update of WHOIS database: 2024-12-05T15:58:13Z <<<
